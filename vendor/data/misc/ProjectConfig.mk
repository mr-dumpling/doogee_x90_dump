...
CUSTOM_HAL_IMGSENSOR = ov8858_mipi_raw gc8034mipi_raw gc5025mipi_raw gc0310_mipi_yuv
CUSTOM_HAL_LENS = ad5823af dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af ad5823af
CUSTOM_HAL_MAIN_IMGSENSOR = ov8858_mipi_raw gc8034mipi_raw gc0310_mipi_yuv
CUSTOM_HAL_MAIN_LENS = dw9714af ad5823af
...
CUSTOM_KERNEL_IMGSENSOR = ov8858_mipi_raw gc8034mipi_raw gc5025mipi_raw gc0310_mipi_yuv
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = ad5823af dw9714af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = no
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9714af ad5823af
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov8858_mipi_raw gc8034mipi_raw gc0310_mipi_yuv
CUSTOM_KERNEL_MAIN_LENS = dw9714af ad5823af
...
CUSTOM_MODEM = w168_haocheng_o1mp2_k80_bsp_hspa_gsm2_3_5_8_w1_8_rda
...
#------------modify by MMI------------------
#版本号
MTK_BUILD_VERNO = DOOGEE_X90_Android8.1-20190527
CUSTOM_BUILD_VERNO = R16_20190527
#广升FOTA
...
#分支信息
HCT_BUILD_PRODUCT_NAME = w168a-dg-a79-wg-128g8g-qhd-bom4-O1-cts
HCT_PRODUCT_TIMEZONE = Europe/Brussels
HCT_REMOVE_IP_PREFIX_SUPPORT = yes
HCT_LOCALIZATION_OVERLAY = zh-rCN

HCT_PRODUCT_BRAND = DOOGEE
HCT_PRODUCT_MODEL = X90
...
#人脸解锁
#HCT_SUPPORT_FACELOCK_AIWINN = yes
FACE_UNLOCK_SUPPORT = true
#app lock 
HCT_SUPPORT_APPLOCK=yes
#自启管理
HCT_SUPPORT_AUTO_BOOT_CONTROL = yes
#省电管理
...
#HCT_QR_CODE_SCAN_DAOGE=yes
HCT_CHROME_SUPPORT = yes
#U型屏幕
#HCT_SUPPORT_NOTCH_SCREEN = yes
HCT_WATER_DROP_SCREEN = yes
#U型屏幕状态栏固定为黑色开关
...
HCT_MEMORY_PHONE=yes
#HCT_GOBOARD_DAOGE=yes
HCT_LCD_RESOULTION_SIZE = QHD
...
HCT_ADUPS_FOTA_DAOGE = yes
HCT_TEE_FINGER_TYPE=Trustkernel
#HCT_SUPPORT_FINGERPRINT=yes
#HCT_SUPPORT_FINGERPRINT_CHIP = cdfiner_fps988e_tee sunwave_tee
...
HCT_PACKAGES_SUBSTITUTE = CalculatorGoogle:- DeskClockGoogle:- Launcher3Go:- PdfViewer:- TagGoogle:- talkback:- WallpaperPicker:- GoboLayout:- GoogleDialerGo:- Videos:- GoogleContacts:- MtkEmail:-
#二次送测cts
HCT_MR_CTS = yes
